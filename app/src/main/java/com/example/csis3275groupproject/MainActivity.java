...
This is the MainActivity java file for the whole app that is run on startup. Lots of stuff will be
in this file in the future so be sure to comment and organize your code nicely to avoid confusion.
...
public  class MainActivity extends AppCompatActivity {
    ...
    //onCreate function that will start the main activity view
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //setting drawer header name, NOT set on this activity
